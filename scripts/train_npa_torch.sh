...
python -u train_npa.py --word_emb_path="../embeddings/cc.nl.300.bin" --test_w_one=1 --random_seed=13
python -u train_npa.py --word_emb_path="../embeddings/cc.nl.300.bin" --test_w_one=1 --random_seed=102
